...
$string['customdatasourcedeleted'] = 'Data source <b>{$a->name}</b> successfully deletedq.';
...
$string['readymatewidgets_help'] = 'Use the below widgets, widgets are easy to use, there is no need to setup additional configurations.';
...
$string['suggestcohort_desc'] = 'Display the users with same cohort in the user\'s contact list block';
$string['suggestcontacts'] = 'Suggested contacts';
$string['suggestgroups'] = 'Suggest users that have same groups';
$string['suggestgroups_desc'] = 'Display the users with same groups in the user\'s contact list block';
$string['suggestinterests'] = 'Suggest users that have same interests';
$string['suggestinterests_desc'] = 'Display the users with same interests in the user\'s contact list block';
...
$string['suggestusers_desc'] = 'Display the users with same users in the user\'s contact list block';
